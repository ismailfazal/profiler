 ...
 */
function ismail_root_relative_url($input) {
...
if (ismail_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'ismail_root_relative_url');
}
